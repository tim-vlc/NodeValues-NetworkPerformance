...
train_size = 43690 if state == 'hole' else 32761
test_size = 22500
train_path = 'data/samples/train_data_f4_' + state + '_' + str(train_size)
test_path = 'data/samples/test_data_f4_plain_' + str(test_size) + '/'
...
test(10,3,lr,µ,input_dim,output_dim,samples,train_size,test_size,sampling_method,max_epochs,activationFunction,1,state)
